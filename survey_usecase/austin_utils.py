...
def compare_results(result_1, title_1, result_2, title_2):
    ...
    columns = ['key point', f'{title_1}_n_sents', f'{title_1}_percent', f'{title_2}_n_sents', f'{title_2}_percent', 'change_n_sents', 'change_percent']
    rows = []
    for kp in kps_in_both:
        ...
        rows.append([kp, sents1, f'{percent1:.2f}%', sents2, f'{percent2:.2f}%', str(math.floor((sents2 - sents1))), f'{(percent2 - percent1):.2f}%'])
